(module
 ...
 (export "validateMutation" (func $assembly/index/validateMutation))
 (export "calculateATPCost" (func $assembly/index/calculateATPCost))
 (export "calculateEntropy" (func $assembly/index/calculateEntropy))
 (export "memory" (memory $0))
 (func $assembly/index/validateMutation (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  local.get $0
  f64.const 0.5
  f64.lt
  local.get $0
 ...
 (func $assembly/index/calculateATPCost (param $0 f64) (param $1 f64) (param $2 i32) (result f64)
  local.get $0
  f64.const 3
 ...
 (func $assembly/index/calculateEntropy (param $0 f64) (param $1 f64) (result f64)
  (local $2 i32)
  (local $3 i64)
  (local $4 f64)
  (local $5 i32)
